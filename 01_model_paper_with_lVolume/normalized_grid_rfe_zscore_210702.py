...
meta_train = sonya.get_zscore_normalized_metadata(file_path0)
meta_test = sonya.get_zscore_normalized_metadata(file_path1)
...
while best_performance < 0.9:
    ...
    is_lMax = False
    exam_name = "zscore_normalized_grid_rfe_" + str(repeat_num)
    ...
    for nf in range(num_properties):
        ...
        PATH_target = os.path.join(PATH_exam, 'base_model_RFE_test00_PR{}'.format(num_features))
